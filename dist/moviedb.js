...
class MovieDb {
  ...
  makeRequest(method, endpoint, params = {}, axiosConfig = {}) {
    ...
    return this.queue.add(async () =>
      (await axios_1.default.request(request)).data
    );
  }
  ...
  movieLatest(params, axiosConfig) {
    return this.makeRequest(
      types_1.HttpMethod.Get,
      "movie/latest",
      (0, lodash_1.isString)(params) ? { language: params } : params,
      axiosConfig,
    );
  }
